# The SGM model in this file is very similar to that in sgm.py.
# The only diff is that here I think the laplacian can not be eig-decomposed by L = U Lam U^H
# So I use L = U Lam U^{-1} (Mar 24, 2023)
import numpy as np
