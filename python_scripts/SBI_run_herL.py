...
# refer to sgm_herL.py (in mypkg/sgm folder) 
...
# paras  for this file
_paras = edict()
_folder_path = f"./herL_reparam{paras.num_prior_sps:.0f}" +               f"_sd{paras.noise_sd*100:.0f}" +               f"_denest{paras.den_est}" +               f"_embed{paras.is_embed}"
